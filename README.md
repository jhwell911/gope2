...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/gope2)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/gope2
```

A live public deployment of this template is available at [https://gope2.templates.workers.dev](https://gope2.templates.workers.dev)
